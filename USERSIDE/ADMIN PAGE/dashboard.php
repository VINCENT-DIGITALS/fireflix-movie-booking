...
class Movie
{
  ...
  {
    global $connection;
    $sql = "SELECT *, DATE_FORMAT(showdate, '%Y-%m-%d') AS showdate,  DATE_FORMAT(releasedate, '%Y-%m-%d') AS releasedate FROM movies ORDER BY MID DESC  ";
...
<body>
  <main>
    ...
    <article class="content" style="margin-left: 25%;">
      <div class="display">
        <table>
          <?php
          global $connection;
          ...
          ?>
            ...
            <tbody class="action">
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td style="font-size: 50px;">No Available Movie</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
